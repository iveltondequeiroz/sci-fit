	    ...
	    return (<div>
				<Toolbar style={toolbarStyles}>
			        ...
			        <Drawer
			          ...
			          onRequestChange={(open) => this.setState({menuopen:!this.state.menuopen})}
			        > 
			        	<MenuItem containerElement={<Link to="/layout" />} leftIcon={<ContentPaste />} onTouchTap={this.handleClose}>Program Layout Maker</MenuItem>
		              	<MenuItem containerElement={<Link to="/training" />} leftIcon={<FitnessCenter />} onTouchTap={this.handleClose}>Trainning Sheet</MenuItem>
		              	<MenuItem containerElement={<Link to="/students" />} leftIcon={<AccountCircle />} onTouchTap={this.handleClose}>Users</MenuItem>
		              	<MenuItem containerElement={<Link to="/programs" />} leftIcon={<ViewList />} onTouchTap={this.handleClose}>Programs</MenuItem>
		              	<MenuItem containerElement={<Link to="/templates" />} leftIcon={<ViewModule />} onTouchTap={this.handleClose}>Templates</MenuItem>
